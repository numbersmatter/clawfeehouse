    ...
    const imageUrl =
      typeof post.data.featuredImage === "string"
        ...
        : post.data.featuredImage?.url ??
          "https://images.unsplash.com/photo-1492724441997-5dc865305da7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHx8fGVufDB8fHx8&auto=format&fit=crop&w=3270&q=80"
